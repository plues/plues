...
public class MappersTest {
    ...
    public void mapSemesterChoice() throws Exception {
        String sc = "{(au1|->sem1),(au2|->sem1),(au3|->sem1),(au4|->sem1),(au5|->sem1),(au6|->sem4),(au7|->sem1),(au8|->sem1),(au9|->sem2)}";
        Set semesterChoice = (Set) Translator.translate(sc);
        Map<Integer, Integer> mapped = Mappers.mapSemesterChoice(semesterChoice);
    ...
    public void mapGroupChoice() throws Exception {
        String gc = "{(unit1|->group1),(unit2|->group12),(unit3|->group3),(unit4|->group4),(unit5|->group11),(unit6|->group6),(unit7|->group7),(unit8|->group10),(unit9|->group9)}";
        Set groupChoice = (Set) Translator.translate(gc);
        Map<Integer, Integer> mapped = Mappers.mapGroupChoice(groupChoice);
        assertEquals((long) mapped.get(1), 1);
    ...
    public void mapUnitChoice() throws Exception {
        String uc = "{(au1|->unit1),(au2|->unit2),(au3|->unit99),(au4|->unit4),(au5|->unit5),(au6|->unit6),(au7|->unit7),(au8|->unit8),(au9|->unit9)}";
        Set unitChoice = (Set) Translator.translate(uc);
        Map<Integer, Integer> mapped = Mappers.mapUnitChoice(unitChoice);
        assertEquals((long) mapped.get(1), 1);
    ...
    public void mapModuleChoice() throws Exception {
        String mc = "{\"foo\" |-> {mod1, mod200}}";
        Set moduleChoice = (Set) Translator.translate(mc);

        HashSet<Integer> t = new HashSet<>();
        t.add(1);
        t.add(200);

        Map<String, java.util.Set<Integer>> mapped = Mappers.mapModuleChoice(moduleChoice);
